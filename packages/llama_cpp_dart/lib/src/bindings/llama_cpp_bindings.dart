...
class LlamaCppBindings {
  ...
  LlamaCppBindings(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LlamaCppBindings.fromLookup(
  ...
  ggml_unary_op ggml_get_unary_op(
    ...
    return ggml_unary_op.fromValue(
      _ggml_get_unary_op(
        tensor,
      ),
    );
  ...
  ggml_backend_dev_type ggml_backend_dev_type$1(
    ...
    return ggml_backend_dev_type.fromValue(
  ...
  llama_pooling_type llama_pooling_type$1(
    ...
    return llama_pooling_type.fromValue(
  ...
  llama_rope_type llama_model_rope_type(
    ...
    return llama_rope_type.fromValue(
  ...
  llama_vocab_type llama_vocab_type$1(
    ...
    return llama_vocab_type.fromValue(
      _llama_vocab_type$1(
        vocab,
      ),
    );
  ...
  llama_token_attr llama_vocab_get_attr(
    ...
    return llama_token_attr.fromValue(
