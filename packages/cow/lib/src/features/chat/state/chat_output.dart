...
/// An agent event for session logging.
final class AgentEventLog extends ChatOutput {
  const AgentEventLog(this.event);

  final AgentEvent event;
}

/// The turn failed — carries error for logging (cubit-level catch).
