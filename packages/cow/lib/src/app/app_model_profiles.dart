...
final class AppModelProfiles {
  ...
  /// Qwen2.5-3B for MLX (Apple Silicon native, lightweight/summary model).
  static final AppModelProfile qwen25_3bMlx = AppModelProfile(
    downloadableModel: DownloadableModel(
      id: AppModelId.qwen25_3bMlx.name,
      entrypointFileName: 'config.json',
      files: const [
        DownloadableModelFile(
          url:
              'https://huggingface.co/mlx-community/Qwen2.5-3B-Instruct-4bit/resolve/main/config.json',
          fileName: 'config.json',
        ),
        DownloadableModelFile(
          url:
              'https://huggingface.co/mlx-community/Qwen2.5-3B-Instruct-4bit/resolve/main/model.safetensors',
          fileName: 'model.safetensors',
        ),
        DownloadableModelFile(
          url:
              'https://huggingface.co/mlx-community/Qwen2.5-3B-Instruct-4bit/resolve/main/model.safetensors.index.json',
          fileName: 'model.safetensors.index.json',
        ),
        DownloadableModelFile(
          url:
              'https://huggingface.co/mlx-community/Qwen2.5-3B-Instruct-4bit/resolve/main/tokenizer.json',
          fileName: 'tokenizer.json',
        ),
        DownloadableModelFile(
          url:
              'https://huggingface.co/mlx-community/Qwen2.5-3B-Instruct-4bit/resolve/main/tokenizer_config.json',
          fileName: 'tokenizer_config.json',
        ),
        DownloadableModelFile(
          url:
              'https://huggingface.co/mlx-community/Qwen2.5-3B-Instruct-4bit/resolve/main/special_tokens_map.json',
          fileName: 'special_tokens_map.json',
        ),
      ],
    ),
  ...
  /// All built-in model profiles, keyed by [AppModelId] name.
  static final Map<String, AppModelProfile> builtins = {
    AppModelId.qwen3.name: qwen3,
    AppModelId.qwen25.name: qwen25,
    AppModelId.qwen25_3b.name: qwen25_3b,
    AppModelId.qwen3Mlx.name: qwen3Mlx,
    AppModelId.qwen25_3bMlx.name: qwen25_3bMlx,
  };
}
