...
class SessionLog {
  SessionLog(String path) : _file = File(path).openSync(mode: FileMode.write);
  ...
  late final StringConversionSink _deltaSink = utf8.encoder
      .startChunkedConversion(_FileByteSink(_file));
